...
envsubst '${BIOPORTAL_API_KEY} ${BIOPORTAL_API_URL} ${BIOPORTAL_PROXY_URL}' < /opt/templates/bioportal_config_development.rb.template > config/bioportal_config_development.rb
